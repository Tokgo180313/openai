<template>
  <div class="container">
    <div class="header">
      ...
      <div class="search-item">
        <a-button type="primary" @click="searchEvent">
            搜索
        </a-button>
    ...
    <a-table :dataSource="dataSource" :columns="columns" :pagination="false">
      <template #bodyCell="{ column, record }">
        <template v-if="column.key == 'action'">
          <a-button type="text" @click="resetEvent(column)">重置</a-button>
          <a-button type="text" @click="removeEvent(column)">删除</a-button>
        </template>
      </template>
    </a-table>
    ...
    <UserAddDialog :visible="showAddUserVisible" @close-modal="closeModalEvent"></UserAddDialog>
  </div>
</template>
